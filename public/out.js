...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__src_matcher__ = __webpack_require__(105);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__src_selectorAll__ = __webpack_require__(106);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__src_selection_style__ = __webpack_require__(109);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__src_locale__ = __webpack_require__(125);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__src_formatSpecifier__ = __webpack_require__(126);
...
var rectangle = exports.rectangle = function () {
	...
	_createClass(rectangle, [{
		key: 'draw',
		value: function draw() {
			var rect = this.parent.element.append("rect").attr("class", "rect").attr("x", this.getX.bind(this)).attr("width", this.getWidth.bind(this)).attr("height", this.getHeight.bind(this)).style("fill", "blue").style("stroke", "red");
...
var _chart = __webpack_require__(468);

var _bar = __webpack_require__(175);

var _rectangle = __webpack_require__(91);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__formatSpecifier__ = __webpack_require__(126);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__formatTypes__ = __webpack_require__(127);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__formatPrefixAuto__ = __webpack_require__(128);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__formatTypes__ = __webpack_require__(127);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__formatPrefixAuto__ = __webpack_require__(128);
...
var _d3Tip = __webpack_require__(469);
...
var selection = exports.selection = function () {
	...
	_createClass(selection, [{
		...
		value: function draw() {
			...
			selection.append("rect").attr("class", "rect").attr("x", this.x).attr("i", this.i).attr("width", this.width).attr("height", this.height).style("fill", "white").attr("stroke", "red").style("opacity", "0.5");
		...
		value: function adapt() {
			...
			if (height < 100) {
				rect.attr("height", 100).style("fill", "white").attr("y", -100 + height).style("stroke", "red").style("opacity", "0.5").attr('stroke-dasharray', '10,5').style('border-top', "0px");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__jiggle__ = __webpack_require__(68);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_d3_quadtree__ = __webpack_require__(69);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__simulation__ = __webpack_require__(124);
...
/* harmony export (immutable) */ __webpack_exports__["a"] = defaultLocale;
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__locale__ = __webpack_require__(125);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__dsv__ = __webpack_require__(150);
...
var triangle = exports.triangle = function () {
	...
	_createClass(triangle, [{
		...
		value: function draw() {
			...
			// left-left triangle
			var tri0 = this.parent.element.append("polygon").attr("class", "draggable ll").attr("fill", "black").style("display", "true").style("cursor", "w-resize");

			// right-right triangle
			var tri1 = this.parent.element.append("polygon").attr("class", "draggable rr").attr("fill", "black").style("display", "true").style("cursor", "e-resize");

			// left-right triangle
			var tri2 = this.parent.element.append("polygon").attr("class", "draggable lr").attr("fill", "black").style("display", "true").style("cursor", "e-resize");

			// right-left triangle
			var tri3 = this.parent.element.append("polygon").attr("class", "draggable rl").attr("fill", "black").style("display", "true").style("cursor", "w-resize");
...
function bindTriangle(tri) {
	...
	tri.element[3].call(d3.drag().on("start", selectedTriangleRL.bind(tri)).on("drag", moveTriangleRL.bind(tri)).on("end", dropTriangleRL.bind(tri)));
}
...
var tag = exports.tag = function () {
	...
	_createClass(tag, [{
		key: 'draw',
		value: function draw() {
			var tag = this.parent.element.append("text").text(this.getTag).attr("dy", this.getDy.bind(this)).style("text-anchor", "middle").style("fill", "black").style("font", "10px sans-serif");
...
var gradBins = exports.gradBins = function () {
	...
	_createClass(gradBins, [{
		...
		key: "splitRight",
		value: function splitRight(d, num) {
			var min = d.pre.i;
			var max = d.next == null ? this.data.length : d.next.i;
			d.i = max;
			for (var i = min; i <= max; i++) {
		...
		key: "resetContainer",
		value: function resetContainer(d) {
